---
description: Initialize AIMFP for the current project directory.
---

Call the aimfp_init MCP tool with the current working directory as project_root.

This creates the .aimfp-project/ directory containing:
