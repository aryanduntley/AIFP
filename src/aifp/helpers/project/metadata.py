"""
AIFP Helper Functions - Project Metadata
...
def initialize_state_database(
    ...
    try:
        ...
        # Assuming this helper is in src/aifp/helpers/project/metadata.py
        aifp_root = Path(__file__).parent.parent.parent
        templates_dir = aifp_root / 'templates' / 'state_db'
