# Directives Mapping Progress

**Purpose**: Track progress as we map directive flows and helper relationships
...
2. **Helper usage** (add to helper used_by_directives):
   - What helpers does this directive use?
