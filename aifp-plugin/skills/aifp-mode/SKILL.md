...
name: aifp-mode
description: >
  AIFP (AI Functional Procedural) behavioral framework. Activates when the AIFP
  ...
  across 4 SQLite databases (aifp_core.db, project.db, user_preferences.db,
  user_directives.db). On every interaction: call aifp_run() first, check project
